classdef FingerSimulator
    ...
    methods
        ...
        function obj = runSimulation(obj, TMag, th_init1, th_init2, th_init3, o_init1, o_init2, o_init3, a_init1, a_init2, a_init3, N_steps, delta_t)
            ...
            obj.theta1_init = th_init1; obj.omega1_init = o_init1; obj.alpha1_init = a_init1;
            obj.theta2_init = th_init2; obj.omega2_init = o_init2; obj.alpha2_init = a_init2;
            obj.theta3_init = th_init3; obj.omega3_init = o_init3; obj.alpha3_init = a_init3;
            ...
            % You can continue the integration loop and hard-stop logic here...
            for k = 2:obj.N
                t = obj.time(k-1);
                ...
                k1 = f3(t         , y3          , y2(1), y1(1));
                k2 = f3(t+obj.dt/2    , y3+obj.dt/2*k1  , y2(1), y1(1));
                k3 = f3(t+obj.dt/2    , y3+obj.dt/2*k2  , y2(1), y1(1));
                k4 = f3(t+obj.dt      , y3+obj.dt  *k3  , y2(1), y1(1));
                ...
                k1 = f2(t         , y3Next(1) , y2          , y1(1) );
                k2 = f2(t+obj.dt/2    , y3Next(1) , y2+obj.dt/2*k1  , y1(1) );
                k3 = f2(t+obj.dt/2    , y3Next(1) , y2+obj.dt/2*k2  , y1(1) );
                k4 = f2(t+obj.dt      , y3Next(1) , y2+obj.dt  *k3  , y1(1) );
                ...
                k1 = f1(t         , y3Next(1), y2Next(1), y1          );
                k2 = f1(t+obj.dt/2    , y3Next(1), y2Next(1), y1+obj.dt/2*k1  );
                k3 = f1(t+obj.dt/2    , y3Next(1), y2Next(1), y1+obj.dt/2*k2  );
                k4 = f1(t+obj.dt      , y3Next(1), y2Next(1), y1+obj.dt  *k3  );
